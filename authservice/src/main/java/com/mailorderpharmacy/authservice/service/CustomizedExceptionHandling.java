...
public class CustomizedExceptionHandling extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleUnauthorizedExceptions(UnauthorizedException uex) {

		log.error("Unauthorized request cdfa");
		return ResponseEntity.badRequest()
				.body(new MessageResponse("Unauthorized request. Login again...", LocalDateTime.now()));
	}
	...
	public ResponseEntity<Object> handleNullPointerExceptions(Exception NullExcp) {
